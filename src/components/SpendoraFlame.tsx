    ...
    >
      ...
      >
        <defs>
          ...
          <radialGradient id="flame-halo" cx="50%" cy="70%" r="40%">
          ...
          <linearGradient id="flame-outer" x1="32" y1="74" x2="30" y2="4" gradientUnits="userSpaceOnUse">
          ...
          <linearGradient id="flame-inner" x1="33" y1="68" x2="31" y2="30" gradientUnits="userSpaceOnUse">
        ...
        {/* Reduced halo */}
        <ellipse cx="32" cy="58" rx="20" ry="14" fill="url(#flame-halo)" />
        ...
        {/* Flame tip flicker — bright point at the top */}
        <motion.ellipse
          cx="30"
          cy="10"
          rx="2"
